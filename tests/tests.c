...
int main(void)
{
	...
	const struct CMUnitTest chip_wp_tests[] = {
		...
		cmocka_unit_test(set_wp_mode_disabled_2srp_test_success),
		cmocka_unit_test(set_wp_mode_disabled_1srp_test_success),
		cmocka_unit_test(set_wp_mode_hardware_2srp_test_success),
		cmocka_unit_test(set_wp_mode_hardware_1srp_test_success),
		cmocka_unit_test(set_wp_mode_power_cycle_2srp_test_success),
		cmocka_unit_test(set_wp_mode_power_cycle_1srp_test_success),
		cmocka_unit_test(set_wp_mode_permanent_2srp_test_success),
		cmocka_unit_test(set_wp_mode_permanent_1srp_test_success),
